...
<Card title="Prezentáció letöltése" icon="document">
A projektvédéshez készített HTML prezentáció letölthető formában.
<a href="letoltes/community-choice-vedes-visual.html" download>Letöltöm →</a>
</Card>
...
<div class="lp-tech-badges">
  ...
  <span class="lp-badge">API Gateway</span>
