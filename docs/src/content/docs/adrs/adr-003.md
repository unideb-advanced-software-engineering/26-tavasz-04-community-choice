...
**We decided for**
- Event-Driven Architecture alkalmazása Apache Kafka topicokkal ([ADR-004](../adr-004/)): a *Szavazási szolgáltatás* és a *Pályázat- és adminisztrációkezelő szolgáltatás* domain eseményeket bocsát ki külön szavazási, kampány- és médiafeldolgozási topicokba, amelyeket az *Értesítési szolgáltatás*, az *Auditnaplózó szolgáltatás* és a *Médiafeldolgozó háttérfolyamat* egymástól teljesen függetlenül, saját Kafka consumer groupon keresztül fogyaszt
...
- a médiafeldolgozási pipeline teljesen leválik a webes szálakról: videófeltöltés után csak objektumtárbeli hivatkozás kerül a médiafeldolgozási topicba, a tömörítés aszinkron, a *Médiafeldolgozó háttérfolyamatban* fut
