...
**We decided for**
- hibrid architektúra alkalmazása, amely ötvözi a [Service-Based Architecture-t (SBA)](ADR-002.md) és az [Event-Driven Architecture-t (EDA)](ADR-003.md): az SBA a szavazási, kampány- és adminisztrációs szolgáltatásokat fedi le, az EDA pedig az értesítési, analitikai és audit komponenseket
