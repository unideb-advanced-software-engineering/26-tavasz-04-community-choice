---
title: "ADR-009"
description: "ADR-009: Dedikált API Gateway a NestJS BFF előtt"
---

# Dedikált API Gateway a NestJS BFF előtt
- Státusz: Aktív
...
**We decided for**
- dedikált API Gateway réteg bevezetése a webes kliensek és a NestJS BFF/domain API-k elé
