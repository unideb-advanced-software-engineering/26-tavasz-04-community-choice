...
A konténerdiagram áttekintő nézet: a webes felületeket, a dedikált API Gatewayt, a NestJS BFF-et, a két fő domain szolgáltatást, az adattárolókat, a tartós event streameket és a háttérfogyasztókat mutatja. A részletes infrastruktúra-elemek, például PgBouncer, KMS és outbox relay, külön fókusznézetben szerepelnek.
