...
Ez a szolgáltatás felel a szavazatok biztonságos rögzítéséért. Tartalmazza a lakóhely-ellenőrző klienst (Zamunda One) és a csak hozzáfűzhető adatrögzítést biztosító logikát.
