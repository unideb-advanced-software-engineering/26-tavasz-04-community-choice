...
* **Mire használjuk?** A teljes rendszert nem építjük erre, mert a szavazás (F-SZ-04) azonnali, szinkron adatbázis-választ igényel. Ugyanakkor három területen **kizárólag eseményvezérelten (Event-Driven)** valósítható meg hatékonyan a funkció:
  * **Médiafeldolgozás (*Pályázat- és adminisztrációkezelő szolgáltatás*):** Amikor egy lakos feltölt egy videót, egy esemény kerül a sorba, amit egy aszinkron háttérfolyamat dolgoz fel. Így a videótömörítés nem akasztja meg a webes/szavazó szálakat.
