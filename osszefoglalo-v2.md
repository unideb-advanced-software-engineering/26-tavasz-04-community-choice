# Community Choice dokumentációs összefoglaló v2

Ez a dokumentum a `docs/src/content/docs/` alatti publikált Astro/Starlight dokumentációs oldalak összefűzött változata. A szakaszok az oldalsáv logikai sorrendjét követik, minden fejezetnél szerepel az eredeti forrásfájl.

- Forráskészlet: `docs/src/content/docs/`
- Fájlok száma: 18
- Generálás dátuma: 2026-05-18
- Megjegyzés: az MDX komponensek, importok és beágyazások az eredeti dokumentációból változatlan tartalomként szerepelnek.

## Tartalomjegyzék

1. [Community Choice](#1-community-choice) - `docs/src/content/docs/index.mdx`
2. [Esettanulmány](#2-esettanulmany) - `docs/src/content/docs/esettanulmany.md`
3. [SRS](#3-srs) - `docs/src/content/docs/srs.mdx`
4. [Fogalomtár](#4-fogalomtar) - `docs/src/content/docs/fogalomtar.md`
5. [Architektúra: Karakterisztikák](#5-architektura-karakterisztikak) - `docs/src/content/docs/architektura/karakterisztikak.md`
6. [Architektúra: Szignifikáns követelmények](#6-architektura-szignifikans-kovetelmenyek) - `docs/src/content/docs/architektura/szignifikans-kovetelmenyek.md`
7. [Architektúra: Stílusválasztás](#7-architektura-stilusvalasztas) - `docs/src/content/docs/architektura/stilusvalasztas.md`
8. [Architektúra: C4 modell](#8-architektura-c4-modell) - `docs/src/content/docs/architektura/c4-modell.mdx`
9. [Architektúra: Implementációs javaslatok](#9-architektura-implementacios-javaslatok) - `docs/src/content/docs/architektura/implementacios-javaslatok.md`
10. [Brand specifikáció](#10-brand-specifikacio) - `docs/src/content/docs/brand-spec.md`
11. [ADR-001](#11-adr-001) - `docs/src/content/docs/adrs/adr-001.md`
12. [ADR-002](#12-adr-002) - `docs/src/content/docs/adrs/adr-002.md`
13. [ADR-003](#13-adr-003) - `docs/src/content/docs/adrs/adr-003.md`
14. [ADR-004](#14-adr-004) - `docs/src/content/docs/adrs/adr-004.md`
15. [ADR-005](#15-adr-005) - `docs/src/content/docs/adrs/adr-005.md`
16. [ADR-006](#16-adr-006) - `docs/src/content/docs/adrs/adr-006.md`
17. [ADR-007](#17-adr-007) - `docs/src/content/docs/adrs/adr-007.md`
18. [ADR-008](#18-adr-008) - `docs/src/content/docs/adrs/adr-008.md`

---

<a id="1-community-choice"></a>
...
<div class="lp-tech-badges">
  ...
  <span class="lp-badge">Debezium CDC</span>
  <span class="lp-badge">Vault / KMS</span>
...
<a id="5-architektura-karakterisztikak"></a>

## 5. Architektúra: Karakterisztikák
...
<a id="6-architektura-szignifikans-kovetelmenyek"></a>

## 6. Architektúra: Szignifikáns követelmények
...
<a id="7-architektura-stilusvalasztas"></a>

## 7. Architektúra: Stílusválasztás
...
<a id="8-architektura-c4-modell"></a>

## 8. Architektúra: C4 modell
...
A konténerdiagram áttekintő nézet: a webes felületeket, az API Gatewayt, a két fő domain szolgáltatást, az adattárolókat, a tartós event streameket és a háttérfogyasztókat mutatja. A részletes infrastruktúra-elemek, például PgBouncer, KMS és CDC relé, külön fókusznézetben szerepelnek.
...
A nyilak az elsődleges kérés-, adat- vagy eseményáramlást mutatják. Szinkron API-hívásoknál a válasz iránya nincs külön berajzolva; aszinkron folyamatoknál a nyíl az esemény tényleges útját követi, például `PostgreSQL -> CDC outbox relé -> vote-cast-events stream`.
...
<a id="9-architektura-implementacios-javaslatok"></a>

## 9. Architektúra: Implementációs javaslatok
...
<a id="10-brand-specifikacio"></a>

## 10. Brand specifikáció
